...
/**
 * Incoming payload for the "Create Listing" form. Bound via
 * @ModelAttribute (not @RequestBody), since the form is a standard
 * multipart/form-data submission carrying an optional image file
...
public class MarketplaceListingCreateDTO {
    ...
    /**
     * Optional - a listing can be created without a photo.
     * Validated for type/size in FileStorageService, not here.
     */
    private MultipartFile image;

    public MarketplaceListingCreateDTO() {
    }
